        ...
        <div class="all">
            ...
            <div class="se">
                <section>
                    <div class="item_list">
			            ...
			            <div class="section">
			            	<div class="ac"><span class="ac1"><span class="ac2">B 코스</span></div>
                    ...
                    <table style="margin: 0 auto;">
                    	...
                    	<tr style="margin: 20px 0 0 0 ;">
                    	<td style="width: 200px;">
                    		<img src="images/forest.png" style="width:120px; margin-right:20px"><br><span style="width: 70px; font-size: 30px;">3일차</span>
                    		</td>
                    	<td>
                        <ul class="table_travle" id="ajaxTable">
                        <%
                        	ArrayList<RecommendVo> list2 = RecommendDAO.getList(type, "3일차");
							for (int i = 0; i < list2.size(); i++) {
						%>
                            	<li class="location_list">
                            		<a href="location_view.jsp?ID=<%= list2.get(i).getLid() %>">
	                                    <img src="images/tourist/<%= list2.get(i).getImg() %>" width="200px" height="200px" class="item_img">
	                                    <br>
	                                    <span id="local" style="padding: 10px; font-size: 20px; font-weight: bold;"><%= list2.get(i).getLocation() %></span>
                                	</a>
                                </li>
                                <%
							}
    						...
    						<div style="display: inline-block;" class="stst">
				                ...
				                <div class="mapbp" style="width: 120px"><button class="mapbtn" onclick="location.href='recommend_23.jsp'">목록</button></div>
    						</div>
					    </div>          
					</div>
				</section>
			...
			<!-- The Modal -->
					    ...
					    <div id="place"><h2>일정 리스트</h2>
					        <div id="placecontent">2박3일</div>
					        <div class="tab">
					            <ul class="tabnav">
					                <li><a href="#tab01" onclick="rbclick1();">A 코스</a></li>
					                <li><a href="#tab02" onclick="rbclick4();">B 코스</a></li>
					                <li><a href="#tab03" onclick="rbclick7();">C 코스</a></li>
					            </ul>
					            <div class="tabcontent">
					                <div id="tab01">
					                    <div id="pl1">
					                        <ul>
					                            ...
					                            <br>
					                            <li><label><input type="radio" value="3" name="place" onclick="rbclick3()">3일차</label>
					                                <ol>
					                                    <li>절물자연휴양림</li>
					                                    <li>함덕해수욕장</li>
					                                    <li>에코랜드 테마파크</li>
					                ...
					                <div id="tab02"><div id="pl2">
					                    <ul>
					                        <li><label><input type="radio" value="4" name="place1" onclick="rbclick4()" checked>1일차</label>
					                            <ol>
					                                <li>에코랜드 테마파크</li>
					                                <li>우도</li>
					                                <li>아쿠아플라넷 제주</li>
					                        ...
					                        <br>
					                        <li><label><input type="radio" value="5" name="place1" onclick="rbclick5()">2일차</label>
					                            <ol>
					                                <li>쇠소깍</li>
					                                <li>대포해안주상절리대</li>
					                                <li>용머리해안</li>
					                        ...
					                        <br>
					                        <li><label><input type="radio" value="6" name="place1" onclick="rbclick6()">3일차</label>
					                            <ol>
					                                <li>오설록 티 뮤지엄</li>
					                                <li>금능해수욕장</li>
					                            </ol>
					                ...
					                <div id="tab03"><div id="pl3">
					                    <ul>
					                        <li><label><input type="radio" value="7" name="place2" onclick="rbclick7()" checked>1일차</label>
					                            <ol>
					                                <li>제주 스카이워터쇼</li>
					                                <li>제주센트럴파크</li>
					                            </ol>
					                        ...
					                        <br>
					                        <li><label><input type="radio" value="8" name="place2" onclick="rbclick8()">2일차</label>
					                            <ol>
					                                <li>오설록 티 뮤지엄</li>
					                                <li>제주신화월드</li>
					                            </ol>
					                        ...
					                        <br>
					                        <li><label><input type="radio" value="9" name="place2" onclick="rbclick9()">3일차</label>
					                            <ol>
					                                <li>소인국 테마파크</li>
					                                <li>한림공원</li>
					                            </ol>
