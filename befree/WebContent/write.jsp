    ...
    <head>
        ...
        <script>
        	$(document).ready(function(){
        		$("#qaWriteOk").click(function(){
        			if($("#qtitle").val() == ""){
        				alert("제목을 입력해주세요");
        				$("#qtitle").focus();
        				return false;
        			}else if($("#qawrite_txt").val() == ""){
        				alert("내용을 입력해주세요");
        				$("#qawrite_txt").focus();
        				return false;
        			}else{
        ...
        <div class="all">
            ...
            <div class="se">
                <section>
                    <div class="item_list">
                        <p class="write">글쓰기</p>
                        <form name = "qaWriteForm" method="post" action="writeAction.jsp">
	                        <table>
	                            <tr><th>제목</th><td><input type="text" name="qtitle" id = "qtitle" size="50"></td></tr>
	                            <tr><th>내용</th><td><textarea id = "qawrite_txt" cols="90" rows="20" name="qcontent" placeholder="내용을 적으시오."></textarea></td></tr>
	                        </table>
	                        <div class="notice_check">
	                        <button type = "button" class="custom-btn btn-5" id = "qaWriteOk"><span><a id="btn">확인</a></span></button>
