            ...
            <div class="se">
                <section>
                    <div class="item_list">
                        ...
                        <p class="QA">추천 여행지</p>
							<div class="one">
							    <h2 class="mid">개발자 추천 여행지</h2>
							</div>
							
							<figure class="snip1585">
						  <img src="images/jejudo/jejudo18.jpg"/>
						  <figcaption>
						    <h3 style="font-size:20px;">개발자 추천 <span style="margin: 2px 0; font-size: 30px;">A코스</span></h3>
						  </figcaption>
						  <a href="recommend_location_A.jsp"></a>
						</figure>
						<figure class="snip1585 hover"><img src="images/jejudo/jejudo19.jpg" />
						  <figcaption>
						    <h3 style="font-size:20px;">개발자 추천 <span style="margin: 2px 0; font-size: 30px;">B코스</span></h3>
						  </figcaption>
						  <a href="recommend_location_B.jsp"></a>
						</figure>
						<figure class="snip1585"><img src="images/jejudo/jejudo20.jpg"/>
						  <figcaption>
						    <h3 style="font-size:20px;">개발자 추천 <span style="margin: 2px 0; font-size: 30px;">C코스</span></h3>
						  </figcaption>
						  <a href="recommend_location_C.jsp"></a>
						</figure>
