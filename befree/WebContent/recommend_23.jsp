            ...
            <div class="se">
                <section>
                    <div class="item_list">
                        ...
                        <p class="QA">추천 여행지</p>
							<div class="one">
							    <h2 class="mid">2박 3일</h2>
							</div>
							
							<figure class="snip1585">
						  <img src="images/jejudo/jejudo15.jpg"/>
						  <figcaption>
						    <h3 style="font-size:20px;">2박 3일 <span style="margin: 2px 0; font-size: 30px;">A코스</span></h3>
						  </figcaption>
						  <a href="recommend_23_A.jsp"></a>
						</figure>
						<figure class="snip1585 hover"><img src="images/jejudo/jejudo16.jpg" />
						  <figcaption>
						    <h3 style="font-size:20px;">2박 3일 <span style="margin: 2px 0; font-size: 30px;">B코스</span></h3>
						  </figcaption>
						  <a href="recommend_23_B.jsp"></a>
						</figure>
						<figure class="snip1585"><img src="images/jejudo/jejudo17.jpg"/>
						  <figcaption>
						    <h3 style="font-size:20px;">2박 3일 <span style="margin: 2px 0; font-size: 30px;">C코스</span></h3>
						  </figcaption>
						  <a href="recommend_23_C.jsp"></a>
						</figure>
